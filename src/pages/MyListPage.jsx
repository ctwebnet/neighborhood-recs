...
const [savedRecs, setSavedRecs] = useState([]);
  ...
  // Check if a rec with this serviceType already exists for this user in that group
  const q = query(
    collection(db, "recommendations"),
  ...
  >
    Share Your List
          ...
          <p className="text-sm text-gray-600 mb-4">
            ...
            {allServiceTypes.length} categories.
          </p>
          ...
          {viewSaved ? (
            <SavedList savedRecs={savedRecs} showGroup={true} />
          ) : (
            <>
